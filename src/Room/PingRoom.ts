import { PingMetadata } from "../Metadata/PingMeta";
import { Client, Delayed, Presence, Room } from "colyseus";
import { getMeta, setMeta } from "../Util/MetaTool";

export default class PingRoom<State = any, Metadata extends Partial<PingMetadata> = Partial<PingMetadata>> extends Room<State, Metadata>{
  ...
  protected startHeartbeat(pingInterval = this.maxPing, calInterval = this.maxPing){
